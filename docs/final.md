...
<iframe width="560" height="315" src="https://www.youtube.com/embed/htVLaEHRHuk" frameborder="0" allowfullscreen>
</iframe>
...
### Baseline:
<p>Our baseline is our agent from the status report. Before training, the agent mostly performs random actions, often running into the walls and into the zombie. It is not good at collecting diamonds either.</p>
